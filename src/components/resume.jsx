		...
		return (
			<section className="resume-container">
				<div className="resume-left-col">
					...
					<p>
						Erfaren utvikler og faglært teknisk konsulent med fartstid innen brukerstøtte, serverdrift og
						ASP-teknologier. For tiden utvikler og partner i Supernode AS.
					</p>
					<p>
						Flere års erfaring med teknisk kundeansvar, og prosjektledelse i IT-prosjekter for en rekke små
						og mellomstore bedrifter. Nå meg på mail@jvik.no.
					</p>
					<hr style={{ borderTop: '3px solid #2c3e50', width: '98%' }} />
					<h5>Address</h5>
